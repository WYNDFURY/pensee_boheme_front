    ...
    <div class="bg-primary_orange px-10 lg:px-20 py-8 text-pretty">
      ...
      <div class="flex flex-col gap-4 text-xl font-light leading-relaxed xl:mx-28 2xl:mx-68">
        ...
        <p class="text-xl text-left">
          ...
          week-end. <br />Vous choisissez le type d'accessoires ainsi que les teintes (en harmonie
          avec celles du mariage, bien sûr !), et je m'occupe de tout le matériel nécessaire pour
          vos créations.
        </p>
        <p class="text-xl text-left">
