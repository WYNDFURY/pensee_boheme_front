<template>
  <header class="bg-[#204534] text-[#fafafa] py-4">
    <div class="container mx-auto px-4 flex items-center justify-between">
      ...
      <div class="hidden md:flex items-center space-x-4">
        <NuxtLink to="/cart" class="hover:text-[#C3E8D7]">Panier</NuxtLink>
        <NuxtLink :to="{ name: 'signin' }" class="hover:text-[#C3E8D7]">S'enregistrer</NuxtLink>
        <NuxtLink :to="{ name: 'login' }" class="hover:text-[#C3E8D7]">Connexion</NuxtLink>
      </div>
      <button class="md:hidden text-[#fafafa]" @click="toggleMenu">
